  ...
  return (
    <div className="space-y-6 font-inter font-normal text-sm text-gray-600">
      <div className="space-y-2 mb-8">
        <h1 className="font-bold text-center text-base">Privacy Policy</h1>
      ...
      <div className="space-y-2 mb-8">
        ...
        <div className="p-4">
          <ul className="list-disc">
            ...
            <li>
              <p>
                <strong>Website</strong> refers to EurekAI, accessible from{" "}
                <a
      ...
      <div className="space-y-4 mb-8">
        ...
        <h4 className="font-medium">Tracking Technologies and Cookies</h4>
        <p>
        ...
        <h3 className="font-semibold">Delete Your Personal Data</h3>
        <p>
        ...
        <h3 className="font-semibold">Disclosure of Your Personal Data</h3>
        <h4 className="font-medium">Business Transactions</h4>
        <p>
        ...
        <h4 className="font-medium">Law enforcement</h4>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="font-medium">Other legal requirements</h4>
        <p>
