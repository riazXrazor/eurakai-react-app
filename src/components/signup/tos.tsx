...
export default function TOS() {
  return (
    <div className="space-y-6 font-inter font-normal text-sm text-gray-600">
      <div className="space-y-2 mb-8">
        <h1 className="text-center font-bold">
          End-User License Agreement (&quot;Agreement&quot;)
        </h1>
        <p className="text-center">Last updated: June 15, 2024</p>
        <p>
          Please read this End-User License Agreement carefully before clicking
          the &quot;I Agree&quot; button, downloading or using EurekAI.
        </p>
      </div>
        ...
        <ul className="list-disc">
          ...
          <li>
            <p>
              ...
              by the Company downloaded by You to a Device, named EurekAI
            </p>
          </li>
          <li>
            <p>
              ...
              in this Agreement) refers to EurekAI, Auckland.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: New Zealand
            </p>
          </li>
          <li>
            <p>
      ...
      <div className="space-y-2 mb-8">
        <h2 className="font-inter font-bold">Acknowledgment</h2>
        <p>
      ...
      <div className="space-y-2 mb-8">
        <h2 className="font-inter font-bold">License</h2>
        <h3 className="font-inter font-semibold">Scope of License</h3>
        <p>
        ...
        <h2 className="font-inter font-bold">Third-Party Services</h2>
        <p>
        ...
        <h2 className="font-inter font-bold">Term and Termination</h2>
        <p>
      ...
      <div className="space-y-2 mb-8">
        <h2 className="font-inter font-bold">Indemnification</h2>
        <p>
          ...
          use of the Application; (b) violation of this Agreement or any law or
          regulation; or (c) violation of any right of a third party.
        </p>
      </div>
      <div className="space-y-2 mb-8">
        <h2 className="font-inter font-bold">No Warranties</h2>
        <p>
      ...
      <div className="space-y-2 mb-8">
        <h2 className="font-inter font-bold">Limitation of Liability</h2>
        <p>
          ...
          through the Application or 100 USD if You haven&apos;t purchased
      ...
      <div className="space-y-2 mb-8">
        <h2 className="font-inter font-bold">Severability and Waiver</h2>
        <h3 className="font-inter font-semibold">Severability</h3>
        <p>
        ...
        <h3 className="font-inter font-semibold">Waiver</h3>
        <p>
      ...
      <div className="space-y-2 mb-8">
        <h2 className="font-inter font-bold">Product Claims</h2>
        <p>
          The Company does not make any warranties concerning the Application.
        </p>
      </div>
      <div className="space-y-2 mb-8">
        <h2 className="font-inter font-bold">United States Legal Compliance</h2>
        <p>
      ...
      <div className="space-y-2 mb-8">
        <h2 className="font-inter font-bold">Changes to this Agreement</h2>
        <p>
      ...
      <div className="space-y-2 mb-8">
        <h2 className="font-inter font-bold">Governing Law</h2>
        <p>
      ...
      <div className="space-y-2 mb-8">
        <h2 className="font-inter font-bold">Entire Agreement</h2>
        <p>
        ...
        <p>
          ...
          You use or purchase other Company&apos;s services, which the Company
      ...
      <div className="space-y-2 mb-8">
        ...
        <ul className="list-disc">
          <li>
            ...
            <a
              href="https://www.eurekai.tech/"
              rel="external nofollow noopener"
              target="_blank"
              className="underline text-[#0449D1]"
            >
              https://www.eurekai.tech/
            </a>
          </li>
        </ul>
      </div>
